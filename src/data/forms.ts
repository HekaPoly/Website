...
export const contactForm: FormConfiguration = {
  title: 'Nous joindre',
  description:
    "Pour toute question, demande de compétition, couverture médiatique ou contact général.",
...
export const partnershipForm: FormConfiguration = {
  ...
  description:
    "Vous souhaitez soutenir Héka ou collaborer avec nos équipes? Décrivez-nous votre intérêt.",
