...
export const currentProjects: Project[] = [
  ...
  // ─────────────────────────────────────────────────────────────────────────
  {
    ...
    technicalObjectives: [
      { title: 'Interprétation naturelle',    desc: "Comprendre des commandes formulées en langage courant, sans syntaxe rigide à apprendre." },
      { title: 'Réponse en temps réel',       desc: "Exécuter les commandes avec une latence minimale pour une expérience fluide." },
      { title: 'Sécurité des mouvements',     desc: "Garantir l'absence de mouvements dangereux grâce à des couches de vérification intégrées." },
      { title: 'Précision de saisie',         desc: "Atteindre et saisir des objets avec une précision suffisante pour des tâches du quotidien." },
      { title: 'Robustesse au bruit',         desc: "Fonctionner correctement dans des environnements sonores variés." },
      { title: "Accessibilité de l'interface",desc: "Rester utilisable par des personnes ayant des capacités motrices et cognitives variables." },
    ],
