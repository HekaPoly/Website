    ...
    <div className="pt-16">
      <section className="relative py-20 lg:py-28 border-b border-border overflow-hidden">
        ...
        <div
            ...
            style={{
              backgroundImage: "url('public/images/team/380406934_305135572284172_3382824170791790552_n-scaled.jpg')",
      ...
      >
        Nous joindre
            ...
            <p className="text-white/80 leading-relaxed max-w-xl">
              Vous souhaitez rejoindre Héka ou simplement prendre contact? Choisissez la
              bonne section ci-dessous.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="grid lg:grid-cols-2 gap-16">
              <div>
                ...
                <div className="mt-8 p-5 rounded-xl bg-heka-light border border-heka-mid">
                  <div className="text-xs font-medium text-heka mb-2" style={{ fontFamily: 'var(--font-mono)' }}>
                    Contact recrutement
                  </div>
                  <a href={`mailto:${site.emailRecruitment}`} className="text-sm text-heka hover:underline">
              ...
              {recSent ? (
                <div className="flex items-center justify-center p-12 rounded-2xl bg-heka-light border border-heka-mid">
                  <div className="text-center">
                    ...
                    <h3 className="text-lg font-semibold text-charcoal mb-2" style={{ fontFamily: 'var(--font-display)' }}>Candidature reçue</h3>
                    <p className="text-sm text-muted">Nous vous répondrons dans les prochains jours.</p>
                  </div>
                </div>
              ) : (
              ...
              <div>
                ...
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    ...
                    <a href={`mailto:${site.email}`} className="text-sm text-heka hover:underline">{site.email}</a>
                  </div>
                  <div className="flex items-start gap-3">
                    ...
                    <span className="text-sm text-muted leading-relaxed whitespace-pre-line">{site.address}</span>
                  </div>
                </div>
              </div>
