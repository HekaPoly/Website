...
export function getAchievementStatusStyle(status: string): string {
  switch (status) {
    case 'completed': return 'text-[#41699d] bg-[#EAF0F8]'
    case 'upcoming':  return 'text-[#C8281A] bg-[#FEF0EF]'
    case 'cancelled': return 'text-[#7A7269] bg-[#F2EEE8]'
    default:          return 'text-[#7A7269] bg-[#F2EEE8]'
  }
}
...
export function getProjectBadgeStyle(projectSlug: string): string {
  switch (projectSlug) {
    case 'podi': return 'text-[#C8281A] bg-[#FEF0EF]'
    case 'bira': return 'text-[#1B4F72] bg-[#E8F0F7]'
    default:     return 'text-[#41699d] bg-[#EAF0F8]'
  }
}
